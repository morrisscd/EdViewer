...
var maps = (function () {
   ...
   // var URL = 'data/PISA GeoJSON - Original.json'
   // var URL = 'data/PISA GeoJSON Working test.json'
    var URL = 'data/nuts1ukungrouped.json'
    var map;
    var marker;
    var lastSelected;
    ...
    function initializeMap() {
        ...
        var isurveys = ["PISA2000", "PISA2003", "PISA2006", "PISA2009", "PISA2012", "PISA2015"];

        for (i = 1; i < 7; i++) {

            var centerControlDiv = document.createElement('div');
            
            var centerControl = new CenterControl(centerControlDiv, map, isurveys[i-1], i);
        ...
        map.data.addListener('mouseover', function(evt) {
            $("#regionName").text( evt.feature.getProperty("ADMIN") );
        ...
        //        //regionalData.processData(evt.feature.getProperty("NUTS112NM"));

        //        regionalData.showSummary(evt.feature.getProperty("NUTS112NM"));
